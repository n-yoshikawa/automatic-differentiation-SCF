...
# CHCH
#mol.build(atom = 'C 0.0021 -0.0041 0.0020; H 0.0163 -1.0540 -0.0038; C -0.0138 1.1698 0.0085; H -0.0281 2.2197 0.0142', basis='ccpvdz', unit='Angstrom')
# CH2CH2
#mol.build(atom = 'C -0.0126 1.0758 0.0080; H 0.0021 -0.0041 0.0020; H 0.9153 1.6285 0.0021; C -1.1558 1.7153 0.0169; H -1.1705 2.7952 0.0228; H -2.0837 1.1627 0.0183', basis='ccpvdz', unit='Angstrom')
# CH3CH3
#mol.build(atom = 'H 0.0021 -0.0041 0.0020; C -0.0127 1.0858 0.0080; H 1.0099 1.4631 0.0003; H -0.5399 1.4469 0.8751; C -0.7288 1.5792 1.2668; H -0.7436 2.6691 1.2728; H -1.7514 1.2020 1.2746; H -0.2017 1.2182 2.1499', basis='ccpvdz', unit='Angstrom')
